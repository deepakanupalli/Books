...
public class QueryExecutionController {
    ...
    @ApiOperation(value = "Process request to execute queries")
    public int executeUpdateBookRating(@RequestParam(value = "rating", required = false) java.lang.Integer rating, @RequestParam(value = "id", required = false) java.lang.Integer id) throws QueryParameterMismatchException {
